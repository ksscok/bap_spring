...
public class UsrPaymentController {
	...
	public String showPaymentSuccess(Model model, String paymentKey, String orderId, String amount, String orderName, String customerName) throws IOException, InterruptedException {
...
//			    .method("POST", HttpRequest.BodyPublishers.ofString("{\"paymentKey\":\"" + paymentKey + "\",\"amount\":\"" + amount + "\",\"orderId\":\"" + orderId + "\"}"))
			    .method("POST", HttpRequest.BodyPublishers.ofString("{\"paymentKey\":\"" + paymentKey + "\",\"amount\":\"" + amount + "\",\"orderId\":\"" + orderId + "\",\"orderName\":\"" + orderName + "\",\"customerName\":\"" + customerName + "\"}"))
			    .build();
