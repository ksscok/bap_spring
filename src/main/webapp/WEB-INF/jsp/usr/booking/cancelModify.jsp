...
<c:set var="pageTitle" value="취소 수정" />
...
<section class="my-20">
	<div class="con-3 mx-auto px-3">
		<form action="../booking/doCancelModify" onsubmit="submitForm(this); return false;">
			<input id="booking_id" type="hidden" name="booking_id" value="${booking.id }" />
			<input id="body" type="hidden" name="body" />
			<div class="my-12 text-2xl font-extrabold">취소 수정</div>
...
<!-- 				추후에 포인트, 쿠폰 등으로 인한 금액을 총 결제 금액에서 뺀 금액으로 넣을 예정 -->
			...
			<div class="btns flex justify-end">
				<a class="text-center btn btn-active btn-secondary mt-4 mr-2" onclick="history.back();">뒤로가기</a>
				<button class="text-center btn btn-active btn-secondary mt-4">수정</button>
			</div>
			<div class="mt-4">
